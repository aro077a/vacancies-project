...
import { deleteCandidatePhoto, uploadCandidatePhoto } from '~/modules/createCandidate/actions';
...
export const EditCandidatePhotoPage: React.FC<RouteComponentProps> = () => {
  const dispatch = useDispatch();
  const { candidatePhoto } = useSelector(state => state.createCandidate);
