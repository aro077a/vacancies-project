...
import { skipCvUpload, uploadCandidateCV } from '~/modules/createCandidate/actions';
...
export const UploadCVPage: React.FC<RouteComponentProps> = ({ history }) => {
  ...
  }, [dispatch, uploadedFile, reset, editMode, history]);
      ...
      {!editMode ? (
        <>
          ...
          <p className={styles['page__subtitle']}>
            We will keep your CV on file so you don't have to upload it each time. You can replace
            with updated file anytime you wish.
          </p>
        </>
      ) : (
        <div className={styles['page__header-wrapper']}>
