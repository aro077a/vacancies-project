...
import { skipLogoUpload, uploadLogo } from '~/modules/companyRegistration/actions';
...
export const UploadLogoPage: React.FC<RouteComponentProps> = () => {
  const dispatch = useDispatch();
  const setupPagesCount = useSelector(state => state.registration.setupPagesCount);
  const uploadingLogo = useSelector(state => state.companyRegistration.uploadingLogo);
  ...
  return (
    <div className={styles['page']}>
      ...
      <p className={styles['page__subtitle']}>We are one step closer, top talent isn't far away.</p>
      {uploadedFile && (
        <div>
